...
export class ConfigService {
  ...
  public enableTerminalAccess = this.runningInDocker
    ? process.env.HOMEBRIDGE_CONFIG_UI_TERMINAL !== '0'
    : this.runningInSynologyPackage || this.runningInPackageMode || Boolean(process.env.HOMEBRIDGE_CONFIG_UI_TERMINAL === '1')
